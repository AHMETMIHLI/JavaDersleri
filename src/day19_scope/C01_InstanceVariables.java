...
public class C01_InstanceVariables {
    /*
        class icerisinde her yerden kullanmak istediginiz variable'leri
        class level'da (class'in icinde ama methodların disinda)
        genellikle class level variable'lar class'in basinda olusturulur (sart degil)

        class leveldaki variable'lar için 2 scope vardir
        1- static variable (Class variable'lari da denir)
    ...
    public static void main(String[] args) {
       int sayi =10;
        ...
        C01_InstanceVariables obje1=new C01_InstanceVariables(); //nedemek?
    ...
    public static void staticMethod(){
        ...
        /*
        instSayi=30;
        instance variablelara main method disindaki static method'lardan da direk ulasamayiz
        obje olustursak ulasabiliriz.
         */
